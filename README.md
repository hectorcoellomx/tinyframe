...
https://github.com/hectorcoellomx/tinyframe  

Repositorio anterior:  
https://github.com/hectorcoellomx/tinyapp  

Este cambio refleja de mejor manera la naturaleza del proyecto:  
un framework PHP sencillo, modular y ligero, ideal para proyectos pequeños y APIs REST.

TinyFrame es un framework de código abierto, propiedad de  
**Héctor de Jesús Coello Gómez.**
